...
public class RESTClient {
	 ...
	 * username de todos los usuarios registrados en el sistema como clave y
	 * sus emails como valor para que el
	 * admin del censo pueda añadir usuarios y se les notifique mediante email.
	 * 
	 */
