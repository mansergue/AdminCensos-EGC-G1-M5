...
public class CensusController extends AbstractController {
	...
	public @ResponseBody Census create(@RequestParam int idVotacion, @RequestParam String fecha_inicio,
			@RequestParam String fecha_fin, String tituloVotacion, @CookieValue("user") String username)
	...
	public ModelAndView addUser(@RequestParam int censusId, @CookieValue("user") String username,
			@RequestParam String username_add) {
	...
	public ModelAndView removeUser(@RequestParam int censusId, @CookieValue("user") String username,
			@RequestParam String username_remove) {
