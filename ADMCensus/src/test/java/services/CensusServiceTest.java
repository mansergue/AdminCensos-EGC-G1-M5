...
public class CensusServiceTest {
	...
	public void createCensus() throws ParseException {
		...
		// Inicializamos HashMap donde especificaremos quién ha votado y quién
		// no, introducimos usuarios
	...
	public void findOneCensus() throws ParseException {
		...
		// Inicializamos una variable de tipo Census y buscamos uno con un id en
		// concreto.
	...
	public void findAllCensuses() throws ParseException {
		...
		// Inicializamos una variable como colección de Censuses agrupando por
		// los censos creados por un usuario en concretro y buscamos que nos
		// devuelva una
		// colección de Censuses.
		// ---------------------------------------------------------------------------
