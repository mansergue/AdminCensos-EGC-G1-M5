...
*/
	 ...
	 */
/*
	public Census findOneByCreator(int censusId) {
...
/*
	public void addUserToClosedCensus(int censusId, String username, String usernameAdd) {
		...
		cuerpoEmail = currentMoment.toString() + "-> Se ha incorporado al censo de " + census.getTitle();
		 ...
		 // Se procede al envio del correo con el resultado de la inclusi�n  en el censo
...
//		 Se procede al envio del correo con el resultado de la exclusi�n del  usuario del censo
		 try {
		 Gmail.send(cuerpoEmail, dirEmail);
		 } catch (Exception e) {
		 e.printStackTrace();
...
//	//Filtrar los censos por comunidades aut�nomas
